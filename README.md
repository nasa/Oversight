...
OverSight takes the Modular Input paramters to create multiple knowledge objects, which are then used to execute scheduled saved searches
and populate KV Store lookups.

The latest version of this document can always be found at https://github.com/nasa/oversight

## Getting Started Walkthough
...
## Walkthrough Lookup Table Contents
...
## Walkthrough Custom Script Output
...
The repo is hosted at https://code.nasa.gov/xxx.
...
* Lookup table views of the kvcollections can be searched using `inputlookup <lookup_name>` e.g. `inputlookup hosts_lookup`
...
This is an open source project hosted at github.com/nasa.
